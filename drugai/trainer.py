...
class Trainer(object):
    ...
    def evaluate(self):
        ...
        tqdm_data = tqdm(eval_dataloader, desc='Evaluation ({})'.format("xx"))
        ...
        tqdm_data.set_postfix({**{"eval_loss": eval_loss}})
        results = {
            "loss": eval_loss
        }
    ...
    def predict(self):
        self.args.test_batch_size = self.args.per_gpu_test_batch_size * max(1, self.args.n_gpu)
